...
#include <libc.h>
#include <draw.h>
// TODO(rjkroege): Remove this eventually.
#include <assert.h>
...
/*
 * Draws a style string in a fashion similar to _string except that there
 * is an accompanying array of style bytes that control what style to
 * draw the character with. style bytes are constrained to printable
 * ascii (i.e. >= 0x20) so that they can be more easily generated by
 * scripts.
*/
Point
